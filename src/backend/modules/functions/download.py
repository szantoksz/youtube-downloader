...
class Download(object):
    ...
    def download(self, job_id, type, url):
        ...
        self.working_directory_path = paths.TEMP_DIRECTORY_PATH / job_id
    ...
    # put the audio and video mp4 into 1 mp4 and auto cleanup the old 2 mp4s
    def transcode_video_and_audio_together(self):
        input_file_1_path = self.working_directory_path / "content_video.mp4"
        input_file_2_path = self.working_directory_path / "content_audio.mp4"
